  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        ...
        <a href="#" onClick={handleInstagramShare} className="p-3 bg-slate-800 hover:bg-gradient-to-r hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F56040] hover:text-white rounded-full transition-all text-slate-300" aria-label="Share on Instagram">
