        ...
        <div className="max-w-3xl mx-auto">
          <FadeIn>
            <h1 className="text-3xl md:text-5xl font-bold mb-8 font-serif text-[#2D2D2D]">
              Términos y <span className="text-[#006a61]">Condiciones</span>
            </h1>
            
            <div className="prose prose-slate prose-lg max-w-none text-slate-700 font-sans leading-relaxed">
              <p>
                Al acceder a The Bestseller Blueprint, aceptas que este es un producto de contenido educativo digital. Debido a la naturaleza de descarga inmediata y acceso instantáneo del producto, no se ofrecen reembolsos. El contenido es propiedad intelectual de Bookish Alchemy AI Studio y no puede ser distribuido sin autorización.
              </p>
            </div>
